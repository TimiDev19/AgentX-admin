    ...
    return (
        <div className=" z-[100] h-[100vh] w-[100vw] bg-[#F5F5F5] dark:bg-[#121212] relative flex items-center justify-center overflow-y-hidden">
            ...
            <div className=" flex items-start justify-center">
                <div className=" z-[10] min-h-[452px] w-[378px] bg-white dark:bg-black rounded-xl p-[30px] flex flex-col items-start justify-start">
                    <h1 className=" font-bold text-[20px] mb-[20px] dark:text-white">Add Attribute</h1>

                    <div className="bg-transparent flex flex-col items-center justify-start w-[100%] rounded-2xl">
                        <div className=" w-full flex items-center justify-between mb-2">
                            <p className=" text-[#00000080] dark:text-[#FFFFFF80] text-[13px] font-bold">Flow Name</p>
                        </div>
                        <div className=" w-full flex items-center justify-between mb-2">
                    ...
                    <div className="bg-transparent flex flex-col items-center justify-start w-[100%] rounded-2xl">
                        <div className=" w-full flex items-center justify-between mb-2">
                            <p className=" text-[#00000080] dark:text-[#FFFFFF80] text-[13px] font-bold">Select Questions</p>
                        </div>
                        <div className=" w-full flex items-center justify-between mb-2">
                    ...
                    <div className="bg-transparent flex flex-col items-center justify-start w-[100%] rounded-2xl">
                        <div className=" w-full flex items-center justify-between mb-2">
                            <p className=" text-[#00000080] dark:text-[#FFFFFF80] text-[13px] font-bold">Attribute Name</p>
                        </div>
                        <div className=" w-full flex items-center justify-between mb-2">
                            <input type="text" className=" text-black dark:text-white bg-transparent border border-[#0000001A] dark:border-[#FFFFFF1A] rounded-xl p-2 focus:outline-none w-[362px]" ></input>
                        </div>
                    ...
                    <div className="bg-transparent flex flex-col items-center justify-start w-[100%] rounded-2xl">
                        <div className=" w-full flex items-center justify-between mb-2">
                            <p className=" text-[#00000080] dark:text-[#FFFFFF80] text-[13px] font-bold">Attribute Key</p>
                        </div>
                        <div className=" w-full flex items-center justify-between mb-2">
                            <input type="text" className=" text-black dark:text-white bg-transparent border border-[#0000001A] dark:border-[#FFFFFF1A] rounded-xl p-2 focus:outline-none w-[362px]" ></input>
                        </div>
