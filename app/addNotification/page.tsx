        ...
        <div className=" z-[100] h-[100vh] w-[100vw] bg-[#F5F5F5] dark:bg-[#121212] relative flex items-center justify-center overflow-y-hidden">
            ...
            <div className=" flex items-start justify-center">
                <div className=" z-[10] min-h-[452px] w-[724px] bg-white dark:bg-black rounded-xl p-[30px] flex flex-col items-start justify-start">
                    <h1 className=" font-bold text-[20px] mb-[20px] dark:text-white">Add New Notification</h1>
                    ...
                    <div className=" w-full flex items-center justify-between mb-[15px]">
                        <div className="bg-transparent flex flex-col items-center justify-start w-[49%] rounded-2xl">
                            <div className=" w-full flex items-center justify-between mb-2">
                                <p className=" text-[#00000080] dark:text-[#FFFFFF80] text-[13px] font-bold">Title</p>
                            </div>
                            <div className=" w-full flex items-center justify-between mb-2">
                        ...
                        <div className="bg-transparent flex flex-col items-center justify-start w-[49%] rounded-2xl">
                            <div className=" w-full flex items-center justify-between mb-2">
                                <p className=" text-[#00000080] dark:text-[#FFFFFF80] text-[13px] font-bold">Channel</p>
                            </div>
                            <div className=" w-full flex items-center justify-between mb-2">
                    ...
                    <div className=" w-full flex items-center justify-between mb-[15px]">
                        <div className="bg-transparent flex flex-col items-center justify-start w-[49%] rounded-2xl">
                            <div className=" w-full flex items-center justify-between mb-2">
                                <p className=" text-[#00000080] dark:text-[#FFFFFF80] text-[13px] font-bold">Select Language</p>
                            </div>
                            <div className=" w-full flex items-center justify-between mb-2">
                                <select className=" text-black dark:text-white bg-transparent border border-[#0000001A] dark:border-[#FFFFFF1A] rounded-xl p-2 focus:outline-none w-full" ></select>
                            </div>
                        ...
                        <div className="bg-transparent flex flex-col items-center justify-start w-[49%] rounded-2xl">
                            <div className=" w-full flex items-center justify-between mb-2">
                                <p className=" text-[#00000080] dark:text-[#FFFFFF80] text-[13px] font-bold">Date & Time</p>
                            </div>
                            <div className=" w-full flex items-center justify-between mb-2">
                                <input type="text" className=" text-black dark:text-white bg-transparent border border-[#0000001A] dark:border-[#FFFFFF1A] rounded-xl p-2 focus:outline-none w-full" ></input>
                            </div>
                    ...
                    <div className=" w-full flex items-center justify-between mb-[15px]">
                        <div className="bg-transparent flex flex-col items-center justify-start w-[49%] rounded-2xl">
                            <div className=" w-full flex items-center justify-between mb-2">
                                <p className=" text-[#00000080] dark:text-[#FFFFFF80] text-[13px] font-bold">Content</p>
                            </div>
                            <div className=" w-full flex items-end justify-between mb-2">
                                <input type="text" className=" h-[118px] text-black dark:text-white bg-transparent border border-[#0000001A] dark:border-[#FFFFFF1A] rounded-xl p-2 focus:outline-none w-full" ></input>
                            </div>
                        </div>
                        <Link
                            href={"/sentNotification"}
                            className=" w-[49%] mx-auto flex items-center justify-center text-white bg-[#000] dark:bg-[#AB4FA8] hover:bg-[black]/60 dark:hover:bg-[#AB4FA8]/60 duration-500 h-[48px] rounded-xl"
                        >
                            Send Notification
                        </Link>
                    </div>
