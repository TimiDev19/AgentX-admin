...
export default function Home() {
  ...
  if (isAuthenticated) {
    return (
      <div className='pl-[20vw] pr-[3vw] w-[100vw] scrollbar-hide overflow-y-scroll bg-[#EDEDED] dark:bg-[#121212] py-[10px] text-black'>
    ...
    return (
      <div className=" z-[100] h-[100vh] w-[100vw] bg-[#F5F5F5] dark:bg-[#121212] fixed flex items-center justify-center">
        <div className=" h-[452px] w-[378px] bg-white dark:bg-black rounded-3xl p-[30px] flex flex-col items-center justify-start">
          <Image
            src={loginLogo}
            alt=""
            className=" mb-[20px]"
