        ...
        <div className=" z-[100] h-[100vh] w-[100vw] bg-[#F5F5F5] dark:bg-[#121212] relative flex items-center justify-center overflow-y-hidden">
            ...
            <div className=" flex items-start justify-center">
                <div className=" z-[10] max-h-[452px] w-[378px] bg-white dark:bg-black rounded-xl p-[30px] flex flex-col items-start justify-start">
                    <h1 className=" font-bold text-[20px] mb-[20px] dark:text-white">Export Report</h1>

                    <div className="bg-transparent flex flex-col items-center justify-start w-[100%] rounded-2xl">
                        <div className=" w-full flex items-center justify-between mb-2">
                            <p className=" text-[#00000080] dark:text-[#FFFFFF80] text-[13px] font-bold">Email ID</p>
                        </div>
                        <div className=" w-full flex items-center justify-between mb-2">
                    ...
                    <div className="bg-transparent flex flex-col items-center justify-start w-[100%] rounded-2xl">
                        <div className=" w-full flex items-center justify-between mb-2">
                            <p className=" text-[#00000080] dark:text-[#FFFFFF80] text-[13px] font-bold">Repeat (Optional)</p>
                        </div>
                        <div className=" w-full flex items-center justify-between mb-2">
                    ...
                    <button className=" bg-transparent text-black hover:text-black/60 dark:hover:text-[#AB4FA8]/60 font-bold text-[14px] dark:text-[#AB4FA8] mt-[10px] mx-auto mb-[15px]">Add New Email</button>
